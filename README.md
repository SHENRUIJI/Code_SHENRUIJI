...
Ниже я приведу скриншоты процесса обучения восьми моделей — YOLOv8n, YOLOv11n, YOLOv8n-SE, ResNet-34, SE-ResNet-34, DenseNet-121, DeiT-Tiny (Data-Efficient Image Transformer) и EfficientFormer-L3 — с целью подтверждения подлинности и работоспособности файлов моделей. Далее я объясню назначение основных файлов кода и укажу использованные источники.

## Скриншоты процесса обучения：
...
Проверка соответствия файлов изображений и их соответствующих файлов меток
...
**datasets/train**  
Обучающие данные из набора данных

**datasets/test**  
Тестовые данные из набора данных
...
**deit and efficicentformer/logs/EfficientFormer/2025-04-19-13-03-55**  
Эта папка содержит результаты обучения EfficientFormer: метрики оценки, время обучения, графики функции потерь во время тренировки и валидации.

**deit and efficicentformer/logs/VisionTransformer/2025-04-18-21-25-54**  
